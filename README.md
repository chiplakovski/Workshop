...
**Ten pages read and write the database** — both hubs, the shop floor's hours screen, the access
screen, Customers, Jobcards, Store, Planning, Reports, and the project half of Project / Estimator. Together they are the chain a
